...
const contactDetails = ref([
  ...
  { label: 'Phone', value: '+62 822 9377 0904', iconPath: 'M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.308 1.154a11.034 11.034 0 005.37 5.37l1.154-2.308a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z' }  // Phone
]);
...
const socialLinks = ref([
  ...
  { name: 'Twitter (X)', href: 'https://x.com/syrauff', iconPath: 'M23 3a10.9 10.9 0 01-3.14 1.53 4.48 4.48 0 00-7.86 3v1A10.66 10.66 0 013 4s-4 9 5 13a11.64 11.64 0 01-7 2c9 5 20 0 20-11.5a4.5 4.5 0 00-.08-.83A7.72 7.72 0 0023 3z' }, // Twitter/X
  { name: 'Instagram', href: 'https://www.instagram.com/syrauff', iconPath: 'M12 2.163c3.204 0 3.584.012 4.85.07 3.252.148 4.771 1.691 4.919 4.919.058 1.265.069 1.645.069 4.849 0 3.205-.012 3.584-.069 4.849-.149 3.225-1.664 4.771-4.919 4.919-1.266.058-1.644.07-4.85.07-3.204 0-3.584-.012-4.849-.07-3.26-.149-4.771-1.699-4.919-4.92-.058-1.265-.07-1.644-.07-4.849 0-3.204.013-3.583.07-4.849.149-3.227 1.664-4.771 4.919-4.919 1.266-.057 1.645-.069 4.849-.069zm0-2.163c-3.259 0-3.667.014-4.947.072-4.358.2-6.78 2.618-6.98 6.98-.059 1.281-.073 1.689-.073 4.948 0 3.259.014 3.668.072 4.948.2 4.358 2.618 6.78 6.98 6.98 1.281.059 1.689.072 4.948.072 3.259 0 3.668-.014 4.948-.072 4.354-.2 6.782-2.618 6.979-6.98.059-1.28.073-1.689.073-4.948s-.014-3.667-.072-4.947c-.196-4.354-2.617-6.78-6.979-6.98-1.281-.059-1.69-.073-4.948-.073zm0 5.838a3.736 3.736 0 100 7.472 3.736 3.736 0 000-7.472zm0 10.368a1.632 1.632 0 110-3.264 1.632 1.632 0 010 3.264z' } // Instagram
]);
...
<template>
  <section 
    id="contact" 
    class="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-slate-950 via-[#0A0A23] to-[#100320] text-gray-200 py-16 px-4 sm:px-6 lg:px-8"
  >
    <div class="w-full max-w-6xl mx-auto flex flex-col justify-center items-center space-y-8 md:space-y-10">
      ...
      <div class="text-center text-gray-500 text-xs mt-10 md:mt-16">
        <p>© {{ currentYear }} Syahrul R. Rauf. All rights reserved.</p>
      </div>
